...
MurkrowEvosAttacks:
	dbbw EVOLVE_LEVEL, 35, HONCHKROW
	db 0 ; no more evolutions
	dbw 1, PECK
	dbw 11, PURSUIT
	dbw 16, HAZE
...
PiloswineEvosAttacks:
	dbbw EVOLVE_LEVEL, 37, MAMOSWINE
	db 0 ; no more evolutions
	dbw 1, HORN_ATTACK
	dbw 1, POWDER_SNOW
	dbw 1, ENDURE
...
DuskullEvosAttacks:
	dbbw EVOLVE_LEVEL, 37, DUSKCLOPS
	db 0
	dbw 1, TACKLE
	dbw 1, LEER
	dbw 4, DISABLE
...
DuskclopsEvosAttacks:
	dbbw EVOLVE_ITEM, WATER_STONE, DUSKNOIR ; Dusk stone
	db 0
	dbw 1, BIND
	dbw 1, LEER
	dbw 12, CONFUSE_RAY
...
PhantumpEvosAttacks:
	dbbw EVOLVE_LEVEL, 40, TREVENANT
	db 0
	dbw 1, TACKLE
	dbw 5, ABSORB
	dbw 8, LEECH_SEED
...
ApplinEvosAttacks:
	dbbw EVOLVE_ITEM, LEAF_STONE, APPLETUN
	db 0
	dbw 1, TACKLE
	dbw 5, WITHDRAW
	db 0
