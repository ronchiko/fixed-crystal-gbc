...
Moves1:
	...
	move EFFECT_NORMAL_HIT,         70, DARK,     100, 20,   0 ;NIGHT_SLASH
	move EFFECT_FLINCH_HIT,			80, DARK, 	  100, 10, 	80 ;DARK_PULSE
	move EFFECT_NORMAL_HIT,		   100, STEEL,	  100, 10,   0 ;HEAVY_SLAM
	...
	move EFFECT_FORCE_SWITCH,		60, DRAGON,	   90, 10,   0 ;DRAGON_TAIL
	move EFFECT_NORMAL_HIT,			85, DRAGON,	  100, 10,   0 ;DRAGON_PULSE
	move EFFECT_ATK_SPD_UP,		     0, DRAGON,   100, 20,   0 ;DRAGON_DANCE
	move EFFECT_SP_SPD_UP,			 0, BUG, 	  100, 20, 	 0 ;QUIVER_DANCE		
